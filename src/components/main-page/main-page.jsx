...
const Location = (loc) => {
  return <li class="locations__item">
...
export const MainPage = (cities) => {
  const locations = cities.cities.cities;
  console.log(locations);
  return (
    <div>
    <div style="display: none">
      <svg xmlns="http://www.w3.org/2000/svg"><symbol id="icon-arrow-select" viewbox="0 0 7 4"><path fill-rule="evenodd" clip-rule="evenodd" d="M0 0l3.5 2.813L7 0v1.084L3.5 4 0 1.084V0z"></path></symbol><symbol id="
      icon-bookmark" viewbox="0 0 17 18"><path d="M3.993 2.185l.017-.092V2c0-.554.449-1 .99-1h10c.522 0 .957.41.997.923l-2.736 14.59-4.814-2.407-.39-.195-.408.153L1.31 16.44 3.993 2.185z"></path></symbol><symbol id="
      icon-star" viewbox="0 0 13 12"><path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 9.644L10.517 12 9.451 7.56 13 4.573l-4.674-.386L6.5 0 4.673 4.187 0 4.573 3.549 7.56 2.483 12 6.5 9.644z"></path></symbol></svg>
    </div>
        ...
        <div class="header__wrapper">
          <div class="header__left">
            <a class="header__logo-link header__logo-link--active">
              <img class="header__logo" src="img/logo.svg" alt="6 cities logo" width="81" height="41"></img>
            </a>
          </div>
    ...
    <main class="page__main page__main--index">
      ...
      <div class="cities tabs">
        <section class="locations container">
          ...
          {locations.map((it, i) => <Location key={i} loc={it} />)}
          </ul>
        </section></div>
        <div class="cities__places-wrapper">
              ...
              <div class="cities__places-list places__list tabs__content">
                <article class="cities__place-card place-card">
                  ...
                  <div class="cities__image-wrapper place-card__image-wrapper">
                    <a href="#">
                      <img class="place-card__image" src="img/apartment-01.jpg" width="260" height="200" alt="Place image"></img>
                    </a>
                  </div>
                ...
                <article class="cities__place-card place-card">
                  <div class="cities__image-wrapper place-card__image-wrapper">
                    <a href="#">
                      <img class="place-card__image" src="img/room.jpg" width="260" height="200" alt="Place image"></img>
                    </a>
                  </div>
                  <div class="place-card__info">
                    <div class="place-card__price-wrapper">
                ...
                <article class="cities__place-card place-card">
                  <div class="cities__image-wrapper place-card__image-wrapper">
                    <a href="#">
                      <img class="place-card__image" src="img/apartment-02.jpg" width="260" height="200" alt="Place image"></img>
                    </a>
                  </div>
                  <div class="place-card__info">
                    <div class="place-card__price-wrapper">
                ...
                <article class="cities__place-card place-card">
                  ...
                  <div class="cities__image-wrapper place-card__image-wrapper">
                    <a href="#">
                      <img class="place-card__image" src="img/apartment-03.jpg" width="260" height="200" alt="Place image"></img>
                    </a>
                  </div>
                  <div class="place-card__info">
                    <div class="place-card__price-wrapper">
